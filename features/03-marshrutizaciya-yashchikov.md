...
>
> ✅ **Разблокирована:** [#21](21-paket-laravel.md) реализована (3.0.0) —
> карта маршрутов задаётся обычным PHP-массивом в опубликованном
> `config/mailspoon.php`, env-сериализация не нужна.

...
> testbench, README/UPGRADE. #03 (маршрутизация) разблокирована. Packagist
> опубликован (2026-06-11). Последний хвост: миграция прода wb2 на тонкое
> хост-приложение (этап 5 ниже).
...
- [x] Packagist: публикация пакета, авто-обновление по GitHub-хуку
      (<https://packagist.org/packages/ttbooking/mailspoon>).
...
- [x] Пакет опубликован на Packagist.
